        ...
        <section class="background-radial-gradient">
            ...
            <!-- Event Info -->
                <div class="flex flex-col w-full lg:flex-row">
                    <div class="flex flex-row justify-around p-4 font-bold leading-none text-gray-800 uppercase bg-gray-400 rounded lg:flex-col lg:items-center lg:justify-center w-full lg:w-1/4">
                    ...
                    <div class="p-4 font-normal text-gray-800 lg:w-3/4">
                        <h1 class="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-800 text-center">Next Match</h1>
                        <div class="flex flex-row mx-auto w-96">
                            <div class="text-center">
                                <img class="h-12 lg:h-24 mx-auto" src="{{ asset ('assets/logos/squads/Namibia FA.png') }}">
        ...
        <div x-data="
            ...
            <div class="bg-white flex flex-col py-1 mx-2 bg-white flex items-center justify-center mx-auto mt-10">
                ...
                <div x-show="openTab === 1" style="display: none;" class="flex flex-col p-4 mx-5">
                    ...
                    @for($i = 0; $i < 5; $i++)
                    <a href="#" class="group">
                        <div class="bg-white flex flex-col md:flex-row border border-gray-200 shadow-md group-hover:shadow-amber-400 group-hover:scale-105 rounded-md my-4 py-4 px-6">
                            ...
                            <div class="flex flex-row mx-auto w-96">
                                <div class="text-center m-auto">
                                    <img class="h-10 mx-auto" src="{{ asset ('assets/logos/squads/Namibia FA.png') }}">
                                    <p class="mt-2 text-xl font-bold">Team A </p>
                                </div>
                                <div class="m-auto">
                                    <p class="m-auto text-xl">TI:ME</p> 
                                    <p class="m-auto text-5xl">vs</p> 
                                </div>
                                <div class="text-center m-auto">
                            ...
                            <div class="flex flex-row h-1/2 my-auto">
                                <button class="bg-amber-400 hover:bg-amber-500 text-white font-bold py-2 px-2 mx-auto my-4 md:mx-2 rounded ">Match Info</button>
                ...
                <div x-show="openTab === 2" style="display: none;" class="flex flex-col p-4">
                    ...
                    @for($i = 0; $i < 5; $i++)
                    <a href="#" class="group">
                        <div class="flex flex-col md:flex-row border border-gray-200 bg-white shadow-md group-hover:shadow-amber-400 group-hover:scale-105 rounded-md my-4 py-4 px-6">
                            <!-- Match details name, date, type -->
                            <div class="my-2 md:m-auto w-full md:w-1/5">
                                <p class="text-sm">Premier League</p>
                                <p class="font-bold text-lg">ma/tch/date</p>
