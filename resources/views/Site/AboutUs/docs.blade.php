            ...
            <section class="pt-10">
                ...
                <div x-data="{
                    ...
                    <div class="flex flex-col md:flex-row text-sm font-medium border-b border-gray-100">
                        ...
                        <a href="javascript:void(0)" @click="openTab = 4"
                    ...
                    <div class="bg-white flex flex-col py-1 mx-2 bg-white flex items-center justify-center mx-auto mt-10">
                        ...
                        <div x-show="openTab === 1" style="display: none;" class="w-full flex flex-col p-4 mx-5">
                            <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                @forelse ($documentlist as $document)
                                    <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 flex flex-row">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" class="h-12"
                                            ...
                                            <g></g><g></g><g></g>
                                                ...
                                                <a href="{{ asset ('storage/docs')}}/{{ $document->file }} " class="ml-2 my-auto hover:text-amber-500">
                                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white hover:text-amber-500">
                                                {{ $document->title }}</h5>
                                        </a>
                        ...
                        <div x-show="openTab === 2" style="display: none;" class="w-full flex flex-col p-4 mx-5">
                            <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div x-show="openTab === 3" style="display: none;" class="w-full flex flex-col p-4 mx-5">
                            <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div x-show="openTab === 4" style="display: none;" class="w-full flex flex-col p-4 mx-5">
                            <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
