        ...
        <section class="mb-32 text-gray-800 text-center lg:text-left background-radial-gradient">
            ...
            <div class="relative overflow-hidden bg-no-repeat bg-cover"
                style="
                    ...
                    background-image: url('{{ asset('assets/images/hq.png') }}');
                    height: 500px;
                  ">
                        ...
                        <div class="grid lg:grid-cols-2 gap-12 flex items-center">
                            <div class="mt-12 lg:mt-0">
                                ...
                                <p class="text-lg" style="color: hsl(0, 0%, 17%)">The mandate of the Namibia Football
                                    ...
                                    regretfully so,
                                    the
                                    NFA was confronted with a leadership LID that determined the limit on the potential for
                                    the
                                    organisational
                                    growth of the Association.

                                    The new NFA, under the administrative and operational authority of the FIFA
                                    Normalisation
                                    Committee is
                                    in
                                    the process to modernise football giving it a true Namibian look and feel to be
                                    accessible,
                                    to be
                                    inclusive
                                    in all aspects of the game, not just in football for senior men, but for women and at
                                    youth
                                    levels for
                                    boys
                                    and girls.
                                    ...
                                    Nationwide First
                                    Division, Regional 2nd Division, Brave Warriors [Senior National Football Men’s Team],
                                    Brave
                                    Gladiators
                                    [Senior National Football Women’s Team] as well as the U/20s and U/17s Boys and Girls,
                                    hoping to
                                    inculcate
                                    Football Used Towards Social Advancement and Learning [FUTSAL] as part of the NFA family
                                    in
                                    the
                                    foreseeable
                                    future.</p>
